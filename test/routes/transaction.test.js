...
beforeAll( async () => {
   ...
   const users = await app.db('users').insert([
        {name: 'User #1', mail: 'user@mail.com', passwd: '$2a$10$sXbmk5B15GW4GY5ohU2jcuX/GSw8FmxZbBOXLTVmL448wsosdqzdi'},
        {name: 'User #2', mail: 'user2@mail.com', passwd: '$2a$10$sXbmk5B15GW4GY5ohU2jcuX/GSw8FmxZbBOXLTVmL448wsosdqzdi'}
    ], '*')
    [user, user2] == users
    delete user.passwd
...
describe('Ao tentar inserir uma transação valida...', () => {
